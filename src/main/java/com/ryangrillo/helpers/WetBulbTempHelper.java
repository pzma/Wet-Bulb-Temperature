...
public class WetBulbTempHelper {
	...
	public String[] calculateWetBulb(WeatherData weatherData, String[] latitudeLongitudeArray) {
		...
		String dwpt = weatherData.getCurrentobservation().getDewp();
		...
		String presMB = weatherData.getCurrentobservation().getsLP();
		...
		String iWspd = weatherData.getCurrentobservation().getWinds();
		...
		double wms = MathCalculations.getWms(spd);
